...
- 5x 60 / 60mm (Pfosten), Länge 1,60m (4 Eckpfosten + 1 Pfosten für _Betteingang_)
...
Wie bereits oben berichtet, haben wir uns bei 3-Pfosten-Verbindung für eine Verbinderart entschieden, wo wir mit 2 Schraubungen auskommen. 
In diesem Zustand hat das Bett bereits eine sehr gute Stabilität und es wurde auch heftig drangehangen und geklettert. Hat alles ausgehalten!
An dieser Stelle sei noch erwähnt, dass wir froh sind uns für die 60 x 60 mm Pfosten entschieden zu haben. Das gibt eine super Stabilität und auch Erwachsene können ohne Probleme mit im Bett liegen.
...
![dummy](/img/first.png){: .center-block :}
...
![dummy](/img/giebel_cut.png){: .center-block :}

Die Giebelbretter werden jeweils mit einer SChraube in den oberen Rahmen verschraubt und stützen sich von beiden Seiten gegen den First.
Hier werden auch von beiden Seiten die Giebelbretter in den First verschraubt.

Den First haben wir dann mit einer Tischkreissäge noch abgeschrägt, damit er optisch im gleichen Winkel wir die Dachschräge zuläuft.
Der Ergebnis sieht dann so aus:

![dummy](/img/first_verschraubt.png){: .center-block :}

Und das fertige Bett (ohne Deko!):

![dummy](/img/bett_fertig.png){: .center-block :}


## Schritt 6: Verschönerungsmaßnahmen

Das Bett ist statisch und funktional nun fertig! Aber, ein Zeltbett ist eigentlich erst gemütlich, sofern es auch eine Hülle bekommt.
Mit einer einfachen Drahtseil und Befestigungsmaterial aus dem Baumarkt, spannt man nun nach Belieben die Führung für einen Vorhang.
Dann besorgt man sich eine LED Lichterkette und wickelt sie um den First. Eine Halterung für die Fernbedienung (für die Lichterkette) könnte so aussehen:

![dummy](/img/bett_fernbedienung.png){: .center-block :}

Und das Bett am Ende:

![dummy](/img/bett_fertig_2.png){: .center-block :}

Unser Kleiner schläft super in seinem Bett für "große Jungs"!
Wir hoffen, dem ein oder anderen ein paar Inspirationen mitgeben zu können. Es ist wirklich nicht zu kompliziert und wenn es einmal steht, hat die ganze Familie Freude dran. 
